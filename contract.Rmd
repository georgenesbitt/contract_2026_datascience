...
- [ ] `r advdate(dayone, 5, topic)`
  ...
  - Finish portfolio piece 4 by `r startweek`:  `r advdate(dayone, 5, assignment=startweek)`
- [ ] `r advdate(dayone, 6, topic)`
  - Finish Lab 6 by `r startweek`:  `r advdate(dayone, 6, assignment=startweek)`
  - Finish Portfolio piece 5 by `r startweek`:  `r advdate(dayone, 6, assignment=startweek)`
- [ ] `r advdate(dayone, 7, topic)`
  - Finish Lab 7 by `r startweek`:  `r advdate(dayone, 7, assignment=startweek)`
  - Finish portfolio piece 6 by `r startweek`:  `r advdate(dayone, 7, assignment=startweek)`
